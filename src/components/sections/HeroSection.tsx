        ...
        <div className="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
          <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
              <h1 className="text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl text-green-800">
            ...
            <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                <p className="text-xl/8 text-gray-600">
                 Notre objectif est de vous accompagner tout au long du processus d&lsquo;laboration et de conception de l&lsquo;histoire que vous souahitez racontez dans le cadre de votre entreprise, ou avec vos amis.</p>
                ...
                <dl className="w-64 space-y-8 xl:w-80">
                  {stats.map((stat) => (
                    <div key={stat.label} className="flex flex-col-reverse gap-y-4">
                      ...
                      <dd className="text-5xl font-semibold tracking-tight  text-orange-400">{stat.value}</dd>
                    </div>
                  ))}
                </dl>
              </div>
